...
_SET_NULL = [
    ...
    ("audit_events", "actor_subject_id", "audit_events_actor_subject_id_fkey", "subjects"),
]

# (table, column, constraint_name, referenced_table)
_CASCADE = [
    ("projects", "owner_subject_id", "projects_owner_subject_id_fkey", "subjects"),
    ("project_memberships", "project_id", "project_memberships_project_id_fkey", "projects"),
    ("project_memberships", "subject_id", "project_memberships_subject_id_fkey", "subjects"),
    ...
    ("upstream_targets", "model_alias_id", "upstream_targets_model_alias_id_fkey", "model_aliases"),
    ("model_team_grants", "model_alias_id", "model_team_grants_model_alias_id_fkey", "model_aliases"),
    ("model_team_grants", "team_id", "model_team_grants_team_id_fkey", "teams"),
    ("model_entitlements", "gateway_key_id", "model_entitlements_gateway_key_id_fkey", "gateway_keys"),
    ("model_entitlements", "model_alias_id", "model_entitlements_model_alias_id_fkey", "model_aliases"),
    ("model_entitlements", "project_id", "model_entitlements_project_id_fkey", "projects"),
    ("model_entitlements", "subject_id", "model_entitlements_subject_id_fkey", "subjects"),
    ("router_command_configs", "model_alias_id", "router_command_configs_model_alias_id_fkey", "model_aliases"),
...
def upgrade() -> None:
    ...
    for table, column, name, ref in _CASCADE:
        ...
        op.create_foreign_key(
            name, table, ref, [column], ["id"], ondelete="CASCADE"
        )
